                        ...
                        <div>
                            ...
                            <div class="flex flex-col my-3">
                                ...
                                <a href="#" class="text-sm text-indigo-800">
                                    {{ $contact->linkedin ?? 'linkedin.com/in/ardhiityo' }}
                                </a>
                            </div>
                            <div class="flex flex-col my-3">
                                <p>
                                ...
                                <p class="text-sm">{{ $contact->phone ?? '089650557420' }} <span
                                        class="text-slate-600">(Ponsel)</span></p>
                            </div>
                            <div class="flex flex-col my-3">
                                <p>
                                ...
                                <a href="#"
                                    class="text-sm text-indigo-800">{{ $contact->user->email ?? 'aryaadi229@gmail.com' }}</a>
                            </div>
                            <div class="flex flex-col my-3">
                                <p>
                                ...
                                <a href="#" class="text-sm text-indigo-800">
                                    {{ $contact->github ?? 'https://github.com/Ardhiityo' }}
                                </a>
                            </div>
                            <div class="flex flex-col my-3">
                                <p>
                                ...
                                <a href="#"
                                    class="text-sm text-indigo-800">{{ $contact->address ?? 'Link. Jombang Wetan RT/RW 001/005 Kelurahan Jombang Wetan, Kecamatan Jombang' }}
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="relative max-w-screen-md mx-auto my-2 bg-white border-2 rounded-lg shadow border-slate-300">
        <div class="p-6 min-h-40 ">
            ...
            <div class="text-sm relative">
                {!! $about->description ?? 'Lorem ipsum dolor sit amet consectetur' !!}
            </div>
            {{-- Collapse --}}
        </div>
    </section>
